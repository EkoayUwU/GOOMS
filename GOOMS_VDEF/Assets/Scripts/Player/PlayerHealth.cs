...
public class PlayerHealth : MonoBehaviour
{
    ...
    private Player_Movement movementScript; // référence au script PlayerMovement attaché au joueur
    ...
    void Start()
    {
        ...
        movementScript = GetComponent<Player_Movement>(); // récupération du script Player_Movement attaché au joueur
        jumpScript= GetComponent<Player_Jump>(); // récup script Player_Jump
